...
#import "VCdutylogwritequery.h"

@implementation VCdutylogwritequery
{
    UIButton *checkbox;
    NSMutableArray *mArray;
    NSString *username,*rolename,*myweekday,*userid,*roleid,*isrecord,*pbdate;
...
-(void)justdoit
{
    ...
    NSMutableURLRequest *therequest=[self getrequest:@"getrunningpbkforwrite" paras:mycontent];
...
- (void)parser:(NSXMLParser *)parser foundCharacters:(NSString *)string
{
    ...
    if ([currentElement isEqualToString:@"isrecord"]) {
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TVdutyelogwritecell* cell=[_tableView dequeueReusableCellWithIdentifier:cellStr];
    if(cell==nil)
    {
        cell=[[TVdutyelogwritecell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellStr];
    }
