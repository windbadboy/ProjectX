...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   //  NSLog(@"%@",[mArray count]);
    ...
    NSString* str=[NSString stringWithFormat:@"%@  (%@)",mynoteinfo.mytitle,mynoteinfo.sendtime];
    cell.textLabel.text=str;
    //子标题
    cell.detailTextLabel.text=[NSString stringWithFormat:@"发送者:%@",mynoteinfo.myusername];
    //图片
