...
-(void)justdoit
{
    ...
    NSMutableURLRequest *therequest=[self getrequest:@"getrunningpbk" paras:a parascontent:b];
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    mydutyinfo *dutyinfo=[[mydutyinfo alloc]init];
    dutyinfo=[mArray objectAtIndex:indexPath.row];
    VCmytb_second* mytbsecond=[[VCmytb_second alloc]init];
    mytbsecond.username=dutyinfo.myusername;
    mytbsecond.pbdate=dutyinfo.mypbdate;
    mytbsecond.rolename=dutyinfo.myrolename;
    mytbsecond.myweekday=dutyinfo.myweekday;
    [self presentViewController:mytbsecond animated:NO completion:nil];
